...
using IdeaGeneratorPersona.ChatControl.Converters;

namespace IdeaGeneratorPersona.ChatControl
{
	public class IdeaGeneratorBotViewModel : NotifyPropertyChangedBase
	{
        ...
        public IdeaGeneratorBotViewModel()
		{
            this.IsBusy = true;
